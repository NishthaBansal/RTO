...
@Entity
@Table(name = "permanent_tbl")
public class PermanentLicence extends BaseEntity {
	@Column(length = 20)
	...
	public PermanentLicence() {
		// TODO Auto-generated constructor stub
	}

	public PermanentLicence(String firstName, String lastName, String email, String aadharNo, String mobileNo,
